...
export default function GlobalError({ error, reset }) {
    useEffect(() => {
        // تسجيل الخطأ في السيرفر أو الكونسول للمتابعة
            ...
            <div className="max-w-md w-full bg-white dark:bg-gray-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 text-center shadow-xl relative overflow-hidden">
                ...
                <div className="relative flex flex-col items-center">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 mb-8 leading-relaxed">
                        حدث خطأ غير متوقع أثناء معالجة الصفحة. يمكنك محاولة إعادة تحميل الصفحة أو العودة إلى الرئيسية.
                    </p>

                    {/* تفاصيل الخطأ للمطورين في بيئة التطوير */}
